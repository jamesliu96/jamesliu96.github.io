...
/* Improved, modified and adapted by James Liu, http://jamesliu.info */
    ...
    */
    ...
    var element, context, Sketch = {
        ...
        augment: function( context, options ) {
            ...
            options.element.className ? (options.element.className += ' sketch') : (options.element.className = "sketch");
